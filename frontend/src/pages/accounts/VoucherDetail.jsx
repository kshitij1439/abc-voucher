...
const AccountsVoucherDetail = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      ...
      catch { toast.error('Not found.'); navigate('/accounts/all-vouchers'); }
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 no-print">
        ...
        <button onClick={() => window.print()} className="flex items-center gap-1.5 px-3 py-2 border border-stone-300 text-sm text-stone-600 rounded hover:bg-stone-50 cursor-pointer">
        ...
        <div className="space-y-4">
            ...
            <div className="bg-white border border-stone-200 rounded-lg p-5">
              ...
              {voucher.directorSignature && (
                <div className="mt-3 pt-3 border-t border-stone-100">
                  ...
                  <img src={voucher.directorSignature} alt="Director" className="max-h-16 border border-stone-200 rounded p-1" />
                </div>
              )}
            </div>
          )}
          ...
          <div className="bg-white border border-stone-200 rounded-lg p-5">
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex justify-between"><span className="text-stone-400">Status</span><StatusBadge status={voucher.status} /></div>
            </div>
          </div>
        </div>
      </div>
