...
const MyVouchers = () => {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-stone-900" style={{ fontFamily: 'var(--font-heading)' }}>My Vouchers</h1>
        <p className="text-xs text-stone-400 mt-0.5">All your expense vouchers</p>
      </div>
      ...
      {loading ? (
        ...
        <VoucherTable vouchers={vouchers} pagination={pagination} onPageChange={setPage}
          ...
          detailPath="/employee/vouchers" showEmployee={false} />
      )}
    </div>
  );
};
