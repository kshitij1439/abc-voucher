        ...
        <div className="flex items-center gap-2">
          {showStatusFilter && (
            <select
              ...
              className="flex-1 sm:flex-initial px-3 py-2 bg-stone-50 border border-stone-200 rounded text-sm text-stone-700 focus:outline-none focus:border-teal-500 cursor-pointer"
            >
              {STATUSES.map((s) => (
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 px-3 py-2 rounded border text-sm cursor-pointer transition-colors ${
